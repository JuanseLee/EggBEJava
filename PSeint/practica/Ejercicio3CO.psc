...
//principal.
	...
	Definir usuario, contrasena, opciones, opcionesSi, opcionesMenu como caracter
	...
	Fin Mientras
sino 
	Escribir "Error! Reinicie el programa e ingrese el usuario correcto!"
FinSi
	...
	Segun opciones Hacer
		"A":
			...
			Leer opcionesMenu
			opcionesMenu=Mayusculas(opcionesMenu)
			Si opcionesMenu = "SI" entonces 
				opciones="C"
			FinSi
		"B":
